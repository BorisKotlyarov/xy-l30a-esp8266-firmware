...
// Topics for MQTT
const char STATUS_TOPIC[] PROGMEM = "device/status";
const char COMMAND_TOPIC[] PROGMEM = "device/command";
// MQTT Topics for XY-L30A/XY-L10A
